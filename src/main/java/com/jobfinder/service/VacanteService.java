...
public class VacanteService implements IVacanteService {
    ...
    public VacanteService() {
        try {
            ...
            v2.setDescripcion("Profesional en: Ingeniería Eléctrica, Ingeniería Electrónica, Ingeniería de Telecomunicaciones, Ingeniería Telemática, Ingeniería de Sistemas, Ingeniería Informática o carreras afines.\n"
                    + "\n"
